...
const products = [
  { name: '아몬드 가루 1kg', brand: '캘리포니아', desc: '고운 아몬드 분말' },
  { name: '코코넛 가루 500g', brand: '필리핀산', desc: '무가당 코코넛' },
  { name: '메밀가루 1kg', brand: '국내산', desc: '100% 순 메밀' },
  { name: '옥수수가루 1kg', brand: '미국산', desc: '곱게 간 옥수수' },
  { name: '녹차가루 500g', brand: '보성산', desc: '국내산 녹차분말' },
  { name: '자색고구마가루 1kg', brand: '국내산', desc: '천연 보라색' },
  { name: '단호박가루 500g', brand: '국내산', desc: '달콤한 단호박' },
  { name: '시나몬가루 500g', brand: '스리랑카산', desc: '향긋한 계피' },
];
        ...
        <section className="py-12 bg-white border-b border-[#E8DCC8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                <h2 className="text-2xl font-bold text-[#4A4039] mb-2">잡가루</h2>
                <p className="text-[#6B5D53]">아몬드가루, 녹차가루 등 특수 가루류를 공급합니다.</p>
              </div>
