...
const products = [
  { name: '백앙금 1kg', brand: '대두식품', desc: '부드러운 질감의 프리미엄 백앙금' },
  { name: '적앙금 1kg', brand: '대두식품', desc: '팥 본연의 맛을 살린 적앙금' },
  { name: '거피팥 500g', brand: '청정원', desc: '껍질 제거한 고급 거피팥' },
  { name: '통팥 1kg', brand: '청정원', desc: '국내산 통팥' },
  { name: '흑임자 페이스트', brand: '대두식품', desc: '검은깨 고소함 가득' },
  { name: '콩가루 500g', brand: '농협', desc: '국내산 콩 100%' },
  { name: '완두앙금 1kg', brand: '대두식품', desc: '은은한 녹색의 완두앙금' },
  { name: '밤앙금 1kg', brand: '대두식품', desc: '밤의 달콤함을 담은 앙금' },
];

export default function LegumePage() {
  return (
    <>
      <Header />
      <main className="min-h-screen bg-[#FAF6F1]">
        <PageHero
          badge="LEGUME PRODUCTS"
          title="두서류가공품"
          subtitle="팥, 콩류 등 고품질 두서류 가공품"
          breadcrumb={[
        ...
        <section className="py-12 bg-white border-b border-[#E8DCC8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                <h2 className="text-2xl font-bold text-[#4A4039] mb-2">두서류가공품</h2>
                <p className="text-[#6B5D53]">앙금류, 팥, 콩가루 등 베이커리에 필수적인 두류 제품을 공급합니다.</p>
              </div>
