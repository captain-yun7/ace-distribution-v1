...
const products = [
  { name: '아몬드 슬라이스 1kg', brand: '캘리포니아', desc: '얇게 슬라이스한 아몬드' },
  { name: '아몬드 분태 1kg', brand: '캘리포니아', desc: '곱게 간 아몬드 분말' },
  { name: '호두 분태 1kg', brand: '미국산', desc: '고소한 호두 분태' },
  { name: '피칸 1kg', brand: '미국산', desc: '고급 피칸 홀' },
  { name: '캐슈넛 1kg', brand: '베트남산', desc: '달콤한 캐슈넛' },
  { name: '마카다미아 500g', brand: '호주산', desc: '프리미엄 마카다미아' },
  { name: '헤이즐넛 1kg', brand: '터키산', desc: '향긋한 헤이즐넛' },
  { name: '피스타치오 500g', brand: '이란산', desc: '녹색빛 피스타치오' },
];
        ...
        <section className="py-12 bg-white border-b border-[#E8DCC8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                <h2 className="text-2xl font-bold text-[#4A4039] mb-2">견과가공품</h2>
                <p className="text-[#6B5D53]">세계 각지에서 엄선한 프리미엄 견과류를 공급합니다.</p>
              </div>
