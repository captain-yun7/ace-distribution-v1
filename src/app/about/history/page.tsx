...
export default function HistoryPage() {
  const timeline = [
    ...
    { year: '2024', title: '매출 245억 달성', desc: '전년 대비 15% 성장, 거래처 500개 돌파' },
    { year: '2022', title: '물류센터 확장 이전', desc: '에이스베이커리 브랜드 런칭, 하남시 물류센터 확장' },
    { year: '2020', title: '창립 10주년 & 특허 취득', desc: '제과제빵류 운반 및 보관용 냉장/냉동장치 특허 취득, 배송차량 20대 증차' },
    { year: '2019', title: '우수기술기업 인증', desc: '제과제빵 재료 유통물류 및 기술마케팅 부문 우수기술기업 인증 획득' },
    { year: '2018', title: '품질인증 획득', desc: 'HACCP 협력업체 인증 취득, 콜드체인 시스템 도입' },
    { year: '2015', title: '본사 사옥 신축 이전', desc: '경기도 하남시 천현동에 자체 물류센터 보유 사옥 신축, 냉동/냉장 운송 인증 취득' },
    { year: '2012', title: '사업 확장', desc: '물류창고 확장, 온라인 주문 시스템 구축' },
    { year: '2010', title: '에이스유통㈜ 창립', desc: '대표이사 안종일 취임, 카페·베이커리 원재료 유통 사업 시작' },
  ];
