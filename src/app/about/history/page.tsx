...
export default function HistoryPage() {
  const timeline = [
    ...
    { year: '2020.09', title: '창립 10주년', desc: '에이스유통 창립 10주년 기념행사 개최' },
    ...
    { year: '2015.06', title: '본사 사옥 신축 이전', desc: '경기도 하남시 천현동에 자체 물류센터 보유 사옥 신축' },
    { year: '2012', title: '매출 100억 달성', desc: '물류창고 확장 이전, 연매출 100억원 달성' },
    { year: '2010.03', title: '에이스유통㈜ 법인 설립', desc: '카페·베이커리 원재료 유통 사업 시작 (직원 5명)' },
  ];
