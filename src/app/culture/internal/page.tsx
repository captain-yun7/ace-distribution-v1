...
export default function InternalCulturePage() {
  ...
  const csrActivities = dbCsrActivities.length > 0
    ...
    : [
    { title: '베이커리 세미나 개최', desc: '소상공인 매출 증대를 위한 무료 세미나를 6년째 연 2회 개최하며 지역 경제 활성화를 지원합니다.', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
    { title: '재해 이웃돕기 후원', desc: '산불 피해 이재민의 일상 회복을 위해 희망브리지를 통해 긴급 구호 성금을 기부합니다.', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
    { title: '지역 상생 협력', desc: '지역 베이커리 및 소상공인과 협력하여 매출 다각화와 지역 경제 활성화에 기여합니다.', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
  ];
