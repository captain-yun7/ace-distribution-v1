  ...
  const faqs = [
    {
      ...
      answer: '에이스유통은 B2B 전문 유통업체로, 전화(031-792-8195) 또는 이메일(ace@acedist.co.kr)을 통해 주문하실 수 있습니다. 신규 거래를 원하시면 담당자와 상담 후 거래 계약을 진행합니다.',
    },
    {
      category: '주문/배송',
    ...
    },
    {
      ...
      answer: '전 제품 콜드체인 시스템을 통해 유통됩니다. 입고부터 배송까지 냉장/냉동 온도가 철저히 유지되며, 매일 품질 점검을 실시합니다. HACCP 협력업체 인증을 보유하고 있습니다.',
    },
    {
      category: '결제',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="text-xl opacity-90">궁금하신 점을 빠르게 확인하세요</p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pr-12 rounded-full border border-beige-300 focus:outline-none focus:ring-2 focus:ring-primary"
            />
            <button className="absolute right-4 top-1/2 -translate-y-1/2 text-text-light hover:text-primary">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full transition-all ${
                  selectedCategory === category
                    ...
                    : 'bg-white text-text-secondary hover:bg-beige-100'
                }`}
              >
                {category}
              </button>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-xs text-primary bg-primary/10 px-2 py-0.5 rounded mr-2">
                        {faq.category}
                      </span>
                ...
                {openIndex === index && (
                  <div className="px-6 pb-5">
                    <div className="flex gap-4 pt-4 border-t">
                      <span className="flex-shrink-0 w-8 h-8 bg-secondary/10 text-secondary rounded-full flex items-center justify-center font-bold">
                        A
                      </span>
          ...
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-3xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-block bg-secondary hover:bg-secondary-dark text-white px-8 py-4 rounded-full transition-colors font-medium"
              >
                전화 문의: 031-792-8195
              </a>
            </div>
