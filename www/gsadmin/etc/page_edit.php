...
<script type="text/javascript">
	...
	<form name="tx_editor_form" id="tx_editor_form" action="page_edit_ok.php" method="post" enctype="multipart/form-data">
	<input type="hidden" name="idx" value="<?=$_GET[idx];?>">
	<h3 class="page-header">페이지수정</h3>
			...
			<table class="table table-bordered table-hover ">
				<tr> 
					...
					<td height="25">
					<?=$row->page_index?>
					<input name="page_index" type="hidden" class="input" maxlength="40" <?=$style->strCheck(2);?> value="<?=$row->page_index;?>"></td> 
				</tr>
				<tr> 
					<td width="150" height="25" align="center" bgcolor="EFEFEF">페이지 타이틀</td>
					<td height="25"><input name="title" type="text" class="input" size="70" value="<?=$row->title;?>"> 간단한 설명</td>
				</tr>
				<tr> 
