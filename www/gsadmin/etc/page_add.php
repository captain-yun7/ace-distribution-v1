...
function sendit() {
	...
	//form.Contents.value = window.frames.Content.document.body.innerHTML;
...
<script type="text/javascript">
	...
	function validForm(editor) {
		// Place your validation logic here
			...
			if (document.tx_editor_form.page_index.value == '') {
				alert("페이지 INDEX를 입력해 주세요.");
				document.tx_editor_form.page_index.focus();
				return false;
			}
	...
	<form name="tx_editor_form" id="tx_editor_form" action="page_add_ok.php" method="post" enctype="multipart/form-data">
	
		
		
			<h3 class="page-header">페이지등록</h3>
			<table class="table table-bordered table-hover ">
				<tr> 
					<td width="150" height="25" align="center" bgcolor="EFEFEF">페이지 INDEX</td>
					<td height="25"><input name="page_index" type="text" class="input" maxlength="40" <?=$style->strCheck(2);?>> 페이지의 일련번호(영문 or 숫자 작성)</td>
				</tr>
				<tr> 
					<td width="150" height="25" align="center" bgcolor="EFEFEF">페이지 타이틀</td>
					<td height="25"><input name="title" type="text" class="input" size="70"> 간단한 설명</td>
				</tr>
				<tr> 
					<td colspan=2 height="25" align="center" bgcolor="EFEFEF">내용입력</td>
				</tr>
				<tr>
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0" height="30">
							...
							<!--tr  height="25">
								<td align="left" class="menu">
									<a href="javascript:textarea_resize(document.page_form.content, 5)"><img src="../images/bt_down.gif" width="19" height="19" border="0" align="absmiddle"></a>
									<a href="javascript:textarea_resize(document.page_form.content, 'reset')"><img src="../images/bt_middle.gif" width="19" height="19" border="0" align="absmiddle"></a>
									<a href="javascript:textarea_resize(document.page_form.content, -5)"><img src="../images/bt_up.gif" width="19" height="19" border="0" align="absmiddle"></a>
									&nbsp;<img src="../images/bt_type.gif" width="64" height="19" border=0 alt="" align="absmiddle">&nbsp;<input name="tag" type="radio" value="0" checked onCLick="inputCheck();">TEXT&nbsp;<input type="radio" name="tag" value="1">HTML&nbsp;<input type="radio" name="tag" value="2">편집기</td>
								<td align="right"><a href="javascript:ftpWinOpen();"><img src="../images/bt_upload.gif" border="0"></a></td>
							</tr-->
							<tr> 
								<td colspan="2" align="center"><div id="tx_trex_container" class="tx-editor-container">
	<!-- 에디터 컨테이너 시작 -->
			...
			<div id="tx_sidebar" class="tx-sidebar">
				<div class="tx-sidebar-boundary">
					...
					<ul class="tx-bar tx-bar-left tx-nav-attach">
						...
						<!-- 이미지 첨부 버튼 끝 -->
						<!-- <li class="tx-list" style="display;none;">
...
<script type="text/javascript">
	var config = {
		...
		txIconPath: "/daumeditor/images/icon/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
...
<script type="text/javascript">
	...
	loadContent();
			...
			<table class="table table-bordered table-hover ">
				<tr> 
					<td height="55" align="center"><a href="#none" onclick="Editor.save();" class="btn btn-primary">저장</a> &nbsp;<a href="page.php" class="btn btn-default">취소</a></td>
				</tr>
			</table>
		</td>
