...
<div class="span10">
						...
						<table  class="table table-striped">
							...
							while( $row = mysql_fetch_object( $result)) {
								...
								if($db->cnt("cs_bbs_data", "where code = '$row->code' and TO_DAYS(reg_date)=TO_DAYS(NOW())")) {
									$new_list_img = "&nbsp;&nbsp;<img src='../images/new1.gif' align='absmiddle'>" ;
								} else {
									$new_list_img="";
								}
							...
							<tr> 
								...
								<th  style="text-align:center;"><a href="bbs_list.php?code=<?=$row->code;?>"><?=$row->name;?></a><?=$new_list_img;?></td>
								<th style="text-align:center;"><?=$row->code;?></th>
								<th style="text-align:center;"><?=$type;?></th>
								<th style="text-align:center;"><?=$pds_check;?></th>
								<th style="text-align:center;"><?=$access_check;?></th>
								<th style="text-align:center;"><?=$write_check;?></th>
								<th style="text-align:center;"><?=$read_check;?></th>
								<th style="text-align:center;"><?=$list_cnt_value;?></th>
								<th style="text-align:center;">
								<a href="javascript:bbsEdit(<?=$row->idx;?>);">수정</a>&nbsp;
								<a href="javascript:bbsDel(<?=$row->idx;?>);">삭제</a>
								</th>
							</tr>
							...
							<tr align="right">
								<td colspan="10">
								<!-- <a href="bbs_admin_reg.php" class="btn btn-primary">등록</a> -->
								</td>
							</tr>
							</tbody>
						...
						<div style="text-align:center;" class="submitBtn">
							<div class="submitBtnBtn">
								<a href="bbs_admin_reg.php" class="btn btn-primary btn-large">게시판 생성</a>
