...
if($mode=="admin"){
	...
	// 디비입력 쿼리
	$sql="update cs_admin set admin_userid='$admin_userid', admin_passwd='$admin_passwd', shop_name='$shop_name', shop_email='$shop_email', shop_domain='$shop_domain', shop_url='$shop_url', spam_text='$spam_text', title_bar='$title', meta_desc='$meta_desc', meta_keyw='$meta_keyw', link_cano='$link_cano', meta_author='$meta_author' where idx=1";
