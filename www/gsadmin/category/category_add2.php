...
$part2_row = $db->object("cs_part", "where idx='$_GET[idx]'");
?>
...
<div>
	<h3 class="page-header">카테고리 기본설정</h3>
		...
		<table class="table table-bordered">
			<form action="category_add2_ok.php" id="tx_editor_form" method="post" name="part_form" enctype="multipart/form-data">
			...
			<caption></caption>
				...
				<tr> 
					<th>카테고리 이름</th>
					<td>&nbsp;
						<input name="part_name" type="text" class="form-control2" maxlength="100" size="50">&nbsp;&nbsp;카테고리 이름을 적어주세요(예:컴퓨터)
					</td>
				</tr>
				...
				<tr> 
					<th>카테고리 코드</th>
					<td>
						&nbsp;1차 코드&nbsp;<input name="part1_code" type="text" class="form-control2" value="<?=$part2_row->part1_code;?>" readonly <? $style->colorAlign('#666666', 0);?>></br>
						&nbsp;2차 코드&nbsp;<input name="part2_code" type="text" class="form-control2" value="<?=time();?>" readonly <? $style->colorAlign('#666666', 0);?>>
						&nbsp;&nbsp;카테고리 코드는 자동으로 생성 됩니다.
					</td>
				</tr>
				...
				<tr> 
					...
					<td>&nbsp;
						...
						<label class="radio-inline"><input type="radio" name="part_low_check" value="1">&nbsp;사용</label>&nbsp;&nbsp;&nbsp;(3차 카테고리를 등록 유무 설정)
					</td>
				</tr>

				<tr style="display:none"> 
					<th style="vertical-align:middle;">내 용</th>
					<th><?include $_SERVER['DOCUMENT_ROOT']."/daumeditor/editor.html";?></th>
				</tr>
