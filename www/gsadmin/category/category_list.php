...
<div>
	<h3 class="page-header">카테고리 등록</h3>
</div>


		<div align="right"><a href="category_add1.php" class="btn btn-danger">1차카테고리 등록</a></div>
		...
		<table class="table table-bordered">		
			...
			<table class="table table-bordered" >
				...
				<tr> <!-- danger --><!-- primary --><!-- warning -->
					...
					<td class="text-center"><span class="btn btn-default "><?echo $part1_display_check_images?></span></td>

					<td class="text-center">			
						<a href="javascript:partEdit( 1, '<?=$part1_row->idx;?>' );" class="btn btn-primary">수 정</a>
						<a href="javascript:partDel( 1,'<?=$part1_row->idx;?>' );" class="btn btn-danger">삭 제</a>
					</td>

					<td class="text-center">
						<?if($part1_row->part_low_check){?>
							<a href="javascript:partReg2('<?=$part1_row->idx;?>');" class="btn btn-primary">2차카테고리 등록</a>
						<?}?>
					</td>
				</tr>
					...
					<tr> 
						...
						<td class="text-center"><span class="btn btn-default "><?echo $part2_display_check_images?></span></td>
						
						<td class="text-center">			
							<a href="javascript:partEdit( 2, '<?=$part2_row->idx;?>' );" class="btn btn-primary">수 정</a>
							<a href="javascript:partDel( 2,'<?=$part2_row->idx;?>' );" class="btn btn-danger">삭 제</a>
						</td>

						<td class="text-center">
							<?if($part2_row->part_low_check){?>
								<a href="javascript:partReg3('<?=$part2_row->idx;?>');" class="btn btn-warning">3차카테고리 등록</a>
							<?}?>
						</td>
					</tr>
						<?
						...
						<tr> 
							...
							<td class="text-center"><span class="btn btn-default "><?echo $part3_display_check_images?></span></td>
							
							<td class="text-center">			
								<a href="javascript:partEdit( 3, '<?=$part3_row->idx;?>' );" class="btn btn-primary">수 정</a>
								<a href="javascript:partDel( 3,'<?=$part3_row->idx;?>' );" class="btn btn-danger">삭 제</a>
							</td>
							<td></td>
						</tr>
						<? 
