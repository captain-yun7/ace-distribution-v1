...
if($_GET[idx]) {
	...
	if( $part_stat->part_index == 1 ) {
		...
		if( $db->delete("cs_part", "where part1_code = '$part_stat->part1_code'") ) { $tools->javaGo('category_list.php'); }
	// 2차 카테고리 삭제 루프
		...
		if( $db->delete("cs_part", "where part2_code = '$part_stat->part2_code' and part1_code = '$part_stat->part1_code'") ) { $tools->javaGo('category_list.php'); }
	// 3차 카테고리 삭제 루프
		...
		if( $db->delete("cs_part", "where part3_code = '$part_stat->part3_code' and part2_code = '$part_stat->part2_code' and part1_code = '$part_stat->part1_code'") ) { $tools->javaGo('category_list.php'); }
	}
} else {
	$tools->errMsg('경 고 !!!\n\n비정상적으로 접근했습니다.');
}
