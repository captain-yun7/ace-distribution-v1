...
<div>
	<h3 class="page-header">카테고리 기본설정</h3>
			...
			<table class="table table-bordered">
				<form action="category_add1_ok.php" id="tx_editor_form" method="post" name="part_form" enctype="multipart/form-data">
			...
			<caption></caption>
				...
				<tr> 
					<th>카테고리 이름</th>
					<td><input name="part_name" type="text" class="form-control " maxlength="100" >&nbsp;&nbsp;카테고리 이름을 적어주세요(예:컴퓨터)</td>
				</tr>

				<tr> 
					<th>카테고리 코드</th>
					<td><input name="part1_code" type="text" class="form-control" maxlength="20" value="<?=time()?>" readonly <? $style->colorAlign('#666666', 0);?>>&nbsp;&nbsp;카테고리 코드는 자동으로 생성 됩니다.</td>
				</tr>
