...
<div>
	<h3 class="page-header">카테고리 기본설정</h3>
		...
		<table class="table table-bordered">
			<form action="category_edit2_ok.php" method="post" name="part_form" id="tx_editor_form" enctype="multipart/form-data">
			...
			<caption></caption>
				...
				<tr> 
					<th>카테고리 이름</th>
					<td>&nbsp;
						<input name="part_name" type="text" class="form-control2" size="50" value="<?=$edit_row->part_name?>" >&nbsp;&nbsp;카테고리 이름을 적어주세요(예:컴퓨터)
					</td>
				</tr>
				...
				<tr> 
					...
					&nbsp;2차 코드&nbsp;<input name="part2_code" type="text" class="form-control" value="<?=$edit_row->part2_code;?>" readonly <? $style->colorAlign('#666666', 0);?>>
					&nbsp;카테고리 코드는 수정할수 없습니다.
					</td>
				</tr>
