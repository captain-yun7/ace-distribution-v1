...
<div>
	<h3 class="page-header">카테고리 기본설정</h3>
		...
		<table class="table table-bordered">
			<form action="category_edit1_ok.php" method="post" name="part_form" id="tx_editor_form" enctype="multipart/form-data">
			<input type="hidden" name="hidden_part_index" value="1">
			<input type="hidden" name="idx" value="<?=$edit_row->idx;?>">
			<input type="hidden" name="hidden_list_display_images1" value="<?=$edit_row->list_display_images1;?>">
			<input type="hidden" name="hidden_list_display_images2" value="<?=$edit_row->list_display_images2;?>">
			...
			<input type="hidden" name="sum_img" value="">
				...
				<tr> 
					<th>카테고리 코드</th>
					<td>&nbsp;
						<input name="part1_code" type="text" class="form-control" value="<?=$edit_row->part1_code?>" readonly <? $style->colorAlign('#666666', 0);?>>&nbsp;&nbsp;카테고리 코드는 수정할수 없습니다.
					</td>
				</tr>
				...
				<tr> 
					...
					<td>&nbsp;
						<label class="radio-inline">
							<input type="radio" name="part_low_check" value="0" <? if( $edit_row->part_low_check == 0 ) { echo( 'checked' ); }?>>&nbsp;미사용
						</label>
						<label class="radio-inline">
							<input type="radio" name="part_low_check" value="1" <? if( $edit_row->part_low_check == 1 ) { echo( 'checked' ); }?>>&nbsp;사용
