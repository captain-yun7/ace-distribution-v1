...
if($_POST[code] ) {
	...
	$sql = "display='$_POST[display]', name='$_POST[name]', company='$_POST[company]', old_price='$_POST[old_price]', shop_price='$_POST[shop_price]', unlimit='$_POST[unlimit]', number='$_POST[number]', point='$_POST[point]', box='$_POST[box]', option_check='$_POST[option_check]', option1_name='$_POST[option1_name]', option1_part='$_POST[hidden_option1_data]', option2_name='$_POST[option2_name]', option2_part='$_POST[hidden_option2_data]', images1='$images1', images2='$images2', add_images1='$add_images1', add_images2='$add_images2', add_images3='$add_images3', add_images4='$add_images4', add_images5='$add_images5', new_mark='$_POST[new_mark]', hit_mark='$_POST[hit_mark]', icon01='$_POST[icon01]', icon02='$_POST[icon02]', icon03='$_POST[icon03]', icon04='$_POST[icon04]', icon05='$_POST[icon05]', icon06='$_POST[icon06]', goods_file='$goods_file_name', tag='$_POST[tag]', content='$body',zzim='$_POST[zzim]' where idx=$goods_data[idx]";

	if( $db->update("cs_goods", $sql) ) { $tools->javaGo("product_total.php"); } else { $tools->errMsg('비상적으로 입력 되었습니다.');}
