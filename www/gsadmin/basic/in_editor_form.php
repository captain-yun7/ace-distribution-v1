...
<script type="text/javascript">
	var config = {
		txHost: 'http://<?=$_SERVER[HTTP_HOST]?>/', /* 런타임 시 리소스들을 로딩할 때 필요한 부분으로, 경로가 변경되면 이 부분 수정이 필요. ex) http://xxx.xxx.com */
		...
		size: {
			contentWidth: 1300 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
		},
		events:
		{
			preventUnload: false
...
<textarea id="tx_load_content" cols="80" rows="10" style="display:none;"><?=$bbs_stat->content;?></textarea>
<script type="text/javascript">
