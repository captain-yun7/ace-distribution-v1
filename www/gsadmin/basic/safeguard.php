...
// 기본 관리자 정보 불러오기.
$bbs_stat = $db->object("cs_page", "where page_index='privacy'");
?>
...
<?include $_SERVER['DOCUMENT_ROOT']."/gsadmin/basic/in_editor_script.php";?>	
 ...
 <h3 class="page-header">개인정보 처리방침</h3>


	<form name="tx_editor_form" id="tx_editor_form" action="safeguard_ok.php" method="post" enctype="multipart/form-data">
