		...
		<div id="tx_trex_container" class="tx-editor-container">
			...
			-->
			<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic" style="display:none;"><div class="tx-toolbar-boundary">
				...
				<ul class="tx-bar tx-bar-left tx-group-tab" style="display:none;" style="display:none;">
					<li class="tx-list">
				...
				<ul class="tx-bar tx-bar-left tx-group-etc" style="display:none;">
					<li class="tx-list">
