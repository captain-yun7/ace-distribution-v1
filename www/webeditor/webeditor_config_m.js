		...
		toolbar: {
            fontfamily: {
               options : [
                    ...
                    { label: TXMSG('@fontfamily.nanumgothic')+' (<span class="tx-txt">가나다라</span>)', title: TXMSG('@fontfamily.nanumgothic'), data: '나눔 고딕,Nanum Gothic,sans-serif', klass: 'tx-nanumgothic' },
...
function setForm(editor) {
		...
		//document.tx_editor_form.target = "actionIframe";
		return true;
}