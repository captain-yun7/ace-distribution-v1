		<!-- 에디터 컨테이너 시작 -->
		<p class="editor-table-txt" style="font-size:11px; padding:5px 0 0 0; text-align:right;">※ 아래 에디터에서 표 삽입시 편집은 가능하나, 반응형 사이트 또는 모바일 사이트에서 표가 화면크기에 반응을 보이기 힘듭니다.</p>
		<div id="tx_trex_container" class="tx-editor-container">
			...
			<div id="tx_sidebar" class="tx-sidebar">
				<div class="tx-sidebar-boundary">
					...
					<ul class="tx-bar tx-bar-left tx-nav-attach">
						...
						<li class="tx-list tx-list-extra" style="display:none;">
						...
						<li class="tx-list tx-list-extra">
							<div id="contents_validate" style="color:#ff0000;font-style:italic;"></div>
						</li>
					</ul>
					<!-- 사이드바 / 우측영역 -->
			...
			<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic"><div class="tx-toolbar-boundary">
				...
				<ul class="tx-bar tx-bar-left tx-group-tab" style="display:none;">
					<li class="tx-list">
				...
				<ul class="tx-bar tx-bar-left tx-group-list" style="display:none;">
					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="/webeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
		...
		<div id="tx_canvas_text_holder" class="tx-holder">
			<textarea id="tx_canvas_text" rows="30" cols="30"></textarea>
					...
					<!-- 높이조절 Start -->
	<div id="tx_resizer" class="tx-resize-bar" style="display:none;">
		<div class="tx-resize-bar-bg"></div>
		<img id="tx_resize_holder" src="/webeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
	<!--div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="/webeditor/images/icon/editor/editor_bi.png" />
		</div>
	</div-->
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="/webeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
				<div class="tx-attach-main">
					...
					<ul class="tx-attach-top">
						...
						<li style="color:#ff0000;">※ 파일 삭제시 복구할 수 없습니다.</li>
...
<!--
	function loadContent() {
		...
		<?
		for($i=1; $i<=$total_plupload; $i++){
			$row_plupload = mysqli_fetch_array($result_plupload);
			$attach_real_ext = explode('/',$row_plupload[url]);
			$attach_ext = $attach_real_ext[sizeof($attach_real_ext)-1];
			$file_size = filesize("$ROOT_DIR/data/plupload/$attach_ext");
		?>
			attachments['image'].push({
				'attacher': 'image',
				'data': {
					'imageurl': '<?=$row_plupload[url]?>',
					'filename': '<?=$row_plupload[filename]?>',
					'filesize': <?=$file_size?>,
					'originalurl': '<?=$row_plupload[url]?>',
					'thumburl': '<?=$row_plupload[url]?>'
				}
			});
		<?}?>
		...
		Editor.modify({
			...
			"content": document.getElementById("contents_source")
		});
	}
	loadContent();
//-->
