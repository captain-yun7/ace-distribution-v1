<table width="668" border="0" cellpadding="0" cellspacing="0" id="recomment">
	<tr> 
		<td><table width="665" border="1" cellspacing="0" cellpadding="0" bordercolor='#D9D9D9' class="menu" style='border-collapse: collapse'>
			<tr>
				<td><table width="663" border="0" cellspacing="0" cellpadding="0">
					<tr> 
						<td colspan="5"><img src="../images/bar_new.gif"></td>
					</tr>
					<tr>
	<?
	$table				= "cs_goods";
	...
	$totalList	= $db->cnt( $table, "where main_position=2" );
	$result		= $db->select( $table, "where main_position=2 order by idx desc LIMIT $startPage, $listScale" );
...
?>
				<td width="20%" align="center" valign="top"><table width="130" border="0" cellspacing="0" cellpadding="0" style='table-layout:fixed;'>
					<tr> 
			...
			<? if(!$new_cnt) {?>
			<tr> 
					<td height="100" align="center" class="menu">등록된 신상품이 없습니다.</td>
			</tr>
			<?}?>
			</tr>
